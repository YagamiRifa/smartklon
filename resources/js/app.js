...
// -------------------------------------------------------
window.Echo.channel("rfid-scanner").listen(".rfid.scanned", (data) => {
    ...
    if (indicator) {
        ...
        setTimeout(
            () => indicator.classList.remove("realtime-indicator--flash"),
            600,
        );
    }
...
window.Echo.connector.pusher.connection.bind("unavailable", () => {
    console.error(
        "[SmartKlon WebSocket] Reverb server tidak tersedia. Jalankan: php artisan reverb:start",
    );
});

window.Echo.connector.pusher.connection.bind("failed", () => {
    console.error(
        "[SmartKlon WebSocket] Koneksi gagal. Periksa host/port Reverb di .env",
    );
});

// // ==============================================================
// // . KODE PENERIMA SIARAN LARAVEL ECHO
// // ==============================================================
// document.addEventListener("DOMContentLoaded", function () {
//     if (window.Echo) {
//         window.Echo.channel("scanner-channel").listen(".batch.scanned", (e) => {
//             const payloadRaspi = {
//                 barcode: e.barcode,
//                 expiry_date: e.expiry_date,
//             };

//             // Memanggil fungsi addBatchLog yang ada di atas
//             addBatchLog(payloadRaspi);
//         });
//     }
// });
