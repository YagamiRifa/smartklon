...
<div id="expiry-detail-modal-overlay" class="detail-modal-overlay" style="display:none;" onclick="closeExpiryDetailModal(event)">
    <div class="detail-modal" style="width:600px" role="dialog" aria-modal="true">
        ...
        <div class="detail-modal-stats">
            ...
            <button type="button" class="btn-action btn-action--edit" style="background: var(--primary-50); color: var(--primary-700); border: none; padding: 6px 10px; border-radius: 6px; cursor: pointer; font-size: 12px; font-weight: 500;"
        onclick="openEditModal('{{ $batch->id }}', '{{ $batch->expiry_date }}', '{{ $batch->item->nama_barang }}')">
    ✏️ Edit
</button>
        </div>
